...
export const gameinstance_is_won: (a: number) => number;
export const gameinstance_move_cube: (a: number, b: number, c: number, d: number) => number;
export const gameinstance_new: () => number;
export const gameinstance_reset: (a: number) => void;
